    ...
    return (
        <div className="space-y-10">
                    ...
                    <Link to={stat.link} key={idx} className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:border-gray-200 transition-all group relative text-left block">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className={`text-[9px] font-black px-2 py-1 rounded-lg ${
                                stat.trend === 'Urgent' || stat.trend === 'Needs Review' ? 'bg-red-50 text-red-600' : 'bg-gray-50 text-gray-400'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
                ...
                <div className="lg:col-span-4 bg-footerBg p-8 rounded-[2.5rem] border border-white/5 shadow-2xl shadow-footerBg/20 text-white flex flex-col relative overflow-hidden text-left h-fit lg:sticky lg:top-8">
                    ...
                    <div className="space-y-4 relative z-10">
                        {products.filter(p => !p.variants || p.variants.some(v => (v.stock || 0) < 15)).slice(0, 4).length > 0 ? (
